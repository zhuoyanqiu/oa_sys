...
<fieldset class="layui-elem-field layui-field-title site-title">
    <legend><a name="methodRender">编辑部门</a></legend>
</fieldset>
<form class="layui-form linksEdit">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" id="parentdepartmentid" name="parentdepartmentid" value="${sysDepartment.parentdepartmentid}">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" value="${sysDepartment.name}" class="layui-input" lay-verify="required" placeholder="请输入机构名称"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">描述信息</label>
        <div class="layui-input-block">
            <input type="text" name="description" value="${sysDepartment.description}" class="layui-input" lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="sort" value="${sysDepartment.sort}" class="layui-input" lay-verify="required" placeholder="请输入排序"/>
        </div>
    </div>
    <%-- <div class="layui-form-item">
